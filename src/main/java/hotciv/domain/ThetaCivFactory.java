...
import hotciv.variants.UnitActionsStrategy.ThetaUnitActionStrategy;
...
public class ThetaCivFactory implements GameFactory {
    ...
    public WorldLayoutStrategy createWorldStrategy() {
        return new DeltaWorldLayout(new ThetaTileMap().getCustomTileMap(), new ThetaUnitMap().unitMap());
    }
}
